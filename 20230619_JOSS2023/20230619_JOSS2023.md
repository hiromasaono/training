...
- Shuya Ikeda, Hiromasa Ono et. al.: TogoID: an exploratory ID converter to bridge biological datasets, Bioinformatics, [doi:10.1093/bioinformatics/btac491](https://doi.org/10.1093/bioinformatics/btac491)
...
# まとめ
  ...
  - TogoDX/human を使って統合されたデータを探索･俯瞰･抽出する
    - 「相互運用性」を高めることによって**高度に統合されたデータベースを探索･俯瞰することで初めて見えてくる新たな知識を抽出できる**仕組みが出来上がりつつある
