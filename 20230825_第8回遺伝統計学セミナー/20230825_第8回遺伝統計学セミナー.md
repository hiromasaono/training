...
----
## 自己紹介
- [小野 浩雅](https://researchmap.jp/hiromasaono) ([Twitter@h_ono](https://twitter.com/h_ono))
...
## 課題
  - 生命科学分野では、DBやバイオインフォマティクスツールの種類や対象が日々増加している
    ...
    - DBやウェブツールを利活用するためのまとまった教材はほとんどない
---
# 統合TV(TogoTV)
...
![bg right:40% 100%](https://raw.githubusercontent.com/hiromasaono/training/master/images/20230731_TogoTVYouTube_stats_Ja.png)
