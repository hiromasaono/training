...
marp: true
theme: uncver
header: "2021/07 第19回臨床遺伝情報検索講習会『統合TVを駆使して、臨床遺伝情報検索のためのデータベース･ウェブツールを探す･学ぶ･使う』"
footer: 2021 Hiromasa Ono @ DBCLS, CC-BY-4.0
paginate: true

---
# 統合TVを駆使して、臨床遺伝情報検索のためのデータベース･ウェブツールを探す･学ぶ･使う
...
これは、日本遺伝子診療学会 第19回臨床遺伝情報検索講習会「統合TVを駆使して、臨床遺伝情報検索のためのデータベース･ウェブツールを探す･学ぶ･使う」の講演資料です。  
- PDF のダウンロード　
  - [http://bit.ly/202107_hono](http://bit.ly/202107_hono)
  - ![](https://raw.githubusercontent.com/hiromasaono/training/master/images/20210609_QR_207835.png)
...
- https://togotv.dbcls.jp/ 📺
  ...
  - 2007年8月サービススタート
  - 2020年11月リニューアル
![bg right:40% 100%](https://raw.githubusercontent.com/hiromasaono/training/master/images/20210609_01.png)
---
# 動画マニュアル
- ウェブサイトへのアクセスの仕方から結果の解釈まで、操作の一挙手一投足がわかる
- 各動画は[YouTubeで公開](http://www.youtube.com/user/togotv/)されており、環境に応じた解像度、倍速表示等で快適に閲覧可能
- 1900本を超える動画が公開されており、のべ200万回以上 (月間3万回以上) 再生
(2021年5月末現在)
- 講義・勉強会、自主学習、新人･後輩指導の教材として誰でも自由に利用できます

![bg right:40% 100%](https://raw.githubusercontent.com/hiromasaono/training/master/images/20210609_02.png)
...
---
# [スキル別コース](https://togotv.dbcls.jp/courses.html)(新設)
...
- 臨床遺伝学の分野については、利用者の方からのリクエストも多く、ここ数年、取り上げているDB、ウェブツールが増加
- NCBI dbSNP、ClinVar、gnomAD、COSMIC、GWAS Catalogなどの国際的なコンソーシアムで開発･運用されているDB
...
- 2021年5月末で45件の[引用論文](https://dbcls.rois.ac.jp/references.html#TogoTV)

![bg right:40% 100%](https://raw.githubusercontent.com/hiromasaono/training/master/images/20210609_04.png)
