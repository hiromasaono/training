...
marp: true
theme: uncver
header: "2021/12/10 第6回遺伝統計学セミナー『統合TVを駆使して、遺伝統計学研究のためのデータベースを探す･学ぶ･使う』"
...
これは、第6回遺伝統計学セミナー「統合TVを駆使して、遺伝統計学研究のためのデータベースを探す･学ぶ･使う」の講演資料です。  
- PDF のダウンロード　
...
© 2021 Hiromasa Ono, [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/deed.ja)　(出典明記でご自由にお使いください)
...
- 1900本を超える動画が公開されており、のべ220万回 (月間3万回以上) 再生
(2021年10月末現在)
- 講義・勉強会、自主学習、新人･後輩指導の教材として誰でも自由に利用できます

![bg right:40% 100%](https://raw.githubusercontent.com/hiromasaono/training/master/images/20211126_02.png)
...
![bg right:40% 100%](https://raw.githubusercontent.com/hiromasaono/training/master/images/20211130_01.png)

---
# AJACSオンライン９「疾患に関する多型データを解析する｣
- 2021年12月16日（木）13:30～17:00 オンライン開催(登録者のみ)
- 日本人類遺伝学会との連携シリーズ
  - 山本先生、才津先生は学会のご推薦
- 後日、統合TVから公開予定
![bg right:40% 100%](https://raw.githubusercontent.com/hiromasaono/training/master/images/20211130_02.png)
