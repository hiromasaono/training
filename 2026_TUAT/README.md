...
- 2024年4月から
  - [広島大学ゲノム編集イノベーションセンター](https://www.mls.sci.hiroshima-u.ac.jp/smg/ge-innovation/index.html) 研究員 / [プラチナバイオ株式会社](https://www.pt-bio.com/) 事業推進部 ディレクター
    - さまざまな産業有用生物のゲノム情報の取得や目的機能に関わる遺伝子の特定、ゲノム編集による機能向上までを一貫して実現し社会課題を解決するプラットフォームをつくる
...
- [【Ⅱ-8】データ分析の実例（演習課題）](#ⅱ-8データ分析の実例演習課題)
...
12. DAVIDを使って皆さんが得た結果を解析・考察してみましょう。
 ...
 - 【演習課題】「マル秘遺伝子リスト」は、 ①どのような実験をした結果得られたデータだと推測できるのか、②なぜそう考えたのかあなたの考えを記載してください。(200文字以上400文字以内程度)
